...
const Footer = () => {
  ...
  /* Resize listener for responsive states */
  useEffect(() => {
    const handleResize = () => {
  ...
  const handleKeyDown = (e, index) => {
    if (window.innerWidth <= 767 && (e.key === "Enter" || e.key === " ")) {
      e.preventDefault();
        ...
        <div className="footer-grid-container">
          ...
          <div className={`footer-col ${activeAccordion === 1 ? "accordion-active" : ""}`}>
            <h3 
              ...
              aria-expanded={isMobile ? activeAccordion === 1 : undefined}
              aria-controls={isMobile ? "footer-links-list-quick" : undefined}
            >
              Quick Links
            ...
            <ul id="footer-links-list-quick" className="footer-links-list">
          ...
          <div className={`footer-col ${activeAccordion === 2 ? "accordion-active" : ""}`}>
            <h3 
              ...
              role={isMobile ? "button" : undefined}
              tabIndex={isMobile ? 0 : undefined}
              aria-expanded={isMobile ? activeAccordion === 2 : undefined}
              aria-controls={isMobile ? "footer-links-list-conf" : undefined}
            >
              Conferences
              <svg className="accordion-arrow" stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" height="1em" width="1em"><polyline points="6 9 12 15 18 9"></polyline></svg>
            </h3>
            <ul id="footer-links-list-conf" className="footer-links-list">
          ...
          <div className={`footer-col ${activeAccordion === 3 ? "accordion-active" : ""}`}>
            <h3 
              ...
              role={isMobile ? "button" : undefined}
              tabIndex={isMobile ? 0 : undefined}
              aria-expanded={isMobile ? activeAccordion === 3 : undefined}
              aria-controls={isMobile ? "footer-contact-info-container" : undefined}
            >
              Contact Info
              <svg className="accordion-arrow" stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" height="1em" width="1em"><polyline points="6 9 12 15 18 9"></polyline></svg>
            </h3>
