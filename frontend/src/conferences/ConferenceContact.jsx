...
const ConferenceContact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post("/api/contact", {
        ...
        subject: `[${conference?.title || "Conference"}] ${formData.subject}`,
  ...
  return (
    <>
      <SEOHead
        title={footerSettings?.contactMetaTitle || `Contact Secretariat | ${conference?.title || "Conference"}`}
        description={footerSettings?.contactMetaDesc || "Contact details for conference organization and committee."}
        keywords={footerSettings?.contactKeywords || "contact, email, phone, office address"}
        canonicalUrl={footerSettings?.contactCanonicalUrl}
        ogImage={footerSettings?.contactOgImage}
        structuredData={{
          "@context": "https://schema.org",
          "@type": "ContactPage",
          "name": `Contact ${conference?.title || "Conference"}`
        }}
      />
          ...
          <div className="conf-contact-card">
            ...
            <div className="conf-contact-left">
              ...
              <p className="conf-contact-text">
                Reach out to the {conference?.title || "Conference"} secretariat.
              </p>
              ...
              <div className="conf-contact-info-list">
                  ...
                  <div className="conf-contact-item-text">
                    ...
                    {googleMap && (
                      <p style={{ marginTop: "6px" }}>
                        <a href={googleMap} target="_blank" rel="noopener noreferrer" style={{ color: "#0052cc", textDecoration: "underline", fontSize: "0.88rem", fontWeight: 600 }}>
                          View on Google Maps →
                        </a>
                      </p>
                    )}
                  ...
                  <div className="conf-contact-item-text">
                    ...
                    {whatsapp && (
                      <p style={{ marginTop: "4px" }}>
                        <a href={`https://wa.me/${whatsapp.replace(/[^0-9]/g, "")}`} target="_blank" rel="noopener noreferrer" style={{ color: "#25D366", fontWeight: 600 }}>
                          💬 WhatsApp: {whatsapp}
                        </a>
                      </p>
                    )}
                ...
                {officeHours && (
                  <div className="conf-contact-item">
                    <div className="conf-contact-icon">🕒</div>
                    <div className="conf-contact-item-text">
                      <h4>Office Hours</h4>
                      <p>{officeHours}</p>
                    </div>
