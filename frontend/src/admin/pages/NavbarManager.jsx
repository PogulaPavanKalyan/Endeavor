...
import NavbarMenuManager from './NavbarMenuManager';
...
const NavbarManager = () => {
  ...
  const [activeTab, setActiveTab] = useState('root'); // 'root' or 'submenu'
  ...
  return (
    <div className="admin-page">
      <div className="admin-page-header">
        <div>
          <h2>Navbar Configurations</h2>
          <p style={{color: '#64748b', fontSize: '14px', marginTop: '4px'}}>
            Manage root navigation pages, edit Dropdown Submenus (Speakers & Scientific Program), and control layout order.
          </p>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', gap: '12px', marginBottom: '24px', borderBottom: '2px solid #e2e8f0' }}>
        <button
          ...
          style={{
            ...
            background: 'none',
            border: 'none',
            borderBottom: activeTab === 'root' ? '3px solid var(--conf-primary, #e74c3c)' : '3px solid transparent',
            color: activeTab === 'root' ? 'var(--conf-primary, #e74c3c)' : '#64748b',
            cursor: 'pointer',
            fontWeight: '600',
            fontSize: '14px',
            outline: 'none',
        ...
        <button
          ...
          style={{
            ...
            background: 'none',
            border: 'none',
            borderBottom: activeTab === 'submenu' ? '3px solid var(--conf-primary, #e74c3c)' : '3px solid transparent',
            color: activeTab === 'submenu' ? 'var(--conf-primary, #e74c3c)' : '#64748b',
            cursor: 'pointer',
            fontWeight: '600',
            fontSize: '14px',
            outline: 'none',
